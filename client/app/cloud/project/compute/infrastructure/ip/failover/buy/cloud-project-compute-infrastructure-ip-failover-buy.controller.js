...
angular.module('managerApp')
  .controller('CloudProjectComputeInfrastructureIpFailoverBuyCtrl',
    function CloudProjectComputeInfrastructureIpFailoverBuyCtrl($q, $scope, $stateParams,
      $translate, $uibModalInstance, $window, atInternet, CucCloudMessage, OvhApiIp,
      OvhApiMe, OvhApiCloudProjectInstance, OvhApiCloudProjectFlavor,
      OvhApiCloudProjectIpFailover, OvhApiOrderCloudProjectIp,
      CLOUD_GEOLOCALISATION, CLOUD_IPFO_ORDER_LIMIT, TRACKING_CLOUD) {
      const self = this;
      ...
      self.confirm = function confirm() {
        atInternet.trackClick({
          name: TRACKING_CLOUD.compute_failover_buy,
          type: 'action',
        });
        buyIps();
      };
