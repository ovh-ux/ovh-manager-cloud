...
angular.module('managerApp')
  ...
  .constant('TRACKING_CLOUD', {
    modification_contact_facturation: 'modification_contact_facturation',
    modification_contact_admin: 'modification_contact_admin',
    billing_rights_validate_contact: 'validation_add_contact',
    billing_rights_add_contact: 'add_contact',
    billing_rights_add_credit: 'bc_credit_cloud',
    billing_rights_activate_voucher: 'confirmation_activation_voucher',
    billing_voucher_activation: 'activation_voucher',
    billing_voucher_credit: 'buy_credit_cloud',
    compute_failover_buy: 'bc_failover_ips_ovh',
    compute_failover_buy_confirm: 'confirm_import_failover_ips_ovh',
    payment_add_server: 'payment_add_serveur',
    payment_add_disk: 'payment_add_disk',
    order_load_balancer: 'order_load_balancer',
    compute_quota_improve_limits: 'improve_limits',
    compute_ssh_validation: 'validation_add_ssh_key',
    compute_ssh_key_add: 'add_ssh_key',
    compute_volume_add_disk: 'add_disk',
    openstack_add_user_confirm: 'confirmation_add_user',
