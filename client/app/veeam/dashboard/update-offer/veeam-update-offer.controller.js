(() => {
    class VeeamUpdateOfferCtrl {
        constructor ($uibModalInstance, serviceName, ControllerHelper, VeeamService) {
            ...
            this.orderInfo = this.ControllerHelper.request.getArrayLoader(() => this.VeeamService.getOrderableOfferPrices(this.serviceName));
            this.orderPost = {};
        ...
        $onInit () {
            this.orderInfo.load()
                .then(() => {
                    ...
                    this.orderInfo.data = this.orderInfo.data[0];
                }).catch(response => {
                    this.orderInfo.data = {};
        ...
        confirm () {
            this.orderPost = this.ControllerHelper.request
                                .getArrayLoader({
                                    loaderFunction: () => this.VeeamService.updateOffer(this.serviceName, this.orderInfo.data.offer, this.orderInfo.data.duration),
