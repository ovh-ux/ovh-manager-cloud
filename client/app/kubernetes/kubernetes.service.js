angular.module("managerApp").service("Kubernetes", class Kubernetes {
    constructor ($q, $translate, OvhApiCloudProject, OvhApiCloudProjectFlavor, OvhApiCloudProjectInstance, OvhApiKube, KUBERNETES) {
        this.$q = $q;
    ...
    getAssociatedInstance (projectId, instanceId) {
        return this.OvhApiCloudProjectInstance.v6().get({ serviceName: projectId, instanceId }).$promise;
    }
    ...
    getFlavors (serviceName) {
        ...
        return this.OvhApiCloudProjectFlavor.v6().query({ serviceName, region: this.KUBERNETES.region }).$promise;
    }
