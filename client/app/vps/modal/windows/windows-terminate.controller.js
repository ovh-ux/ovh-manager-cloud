class VpsTerminateWindowsCtrl {
    ...
    confirm () {
        ...
        this.VpsService.cancelOption(this.serviceName, "windows")
...
angular.module("managerApp").controller("VpsTerminateWindowsCtrl", VpsTerminateWindowsCtrl);
