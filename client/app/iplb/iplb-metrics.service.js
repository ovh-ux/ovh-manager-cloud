class IpLoadBalancerMetricsService {
  constructor(
    $http, $stateParams, $translate, IpLoadBalancerConstant, TARGET, OvhApiIpLoadBalancing,
  ) {
    this.$http = $http;
    ...
    this.url = _.get(
      IpLoadBalancerConstant.metricsUrl,
      TARGET,
      _.get(IpLoadBalancerConstant.metricsUrl, 'default'),
    );
    this.path = 'query';
