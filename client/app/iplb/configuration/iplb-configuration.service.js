class IpLoadBalancerConfigurationService {
  ...
  refresh(serviceName, zone) {
    return this.IpLoadBalancing.v6()
      ...
      .then(() => this.CucServiceHelper.successHandler('iplb_configuration_apply_success')(null))
  ...
  batchRefresh(serviceName, zones) {
    ...
    return this.$q
      .all(promises)
      .then((refreshResults) => {
        refreshResults.forEach(() => this.CucServiceHelper.successHandler('iplb_configuration_apply_success')(null));
      })
      .catch(this.CucServiceHelper.errorHandler('iplb_configuration_apply_error'));
  }
