  ...
  getAssistanceMenu(subsidiary) {
    ...
    const assistanceMenuItems = [
      ...
      },
      {
        ...
        mustBeKept: !mustDisplayNewMenu && _.has(this.URLS.guides, `home.${subsidiary}`),
      },
      {
        title: this.$translate.instant('common_menu_support_help_and_contact'),
        url: _.get(this.URLS.guides, 'home.FR'),
        isExternal: true,
        click: () => this.atInternet.trackClick({
          name: 'assistance::all_guides',
          type: 'action',
        }),
        mustBeKept: mustDisplayNewMenu && _.has(this.URLS.guides, 'home.FR'),
      },
      {
      ...
      },
      {
        ...
        mustBeKept: _.has(this.REDIRECT_URLS, 'support'),
      },
      {
