...
.service("Toaster", function ($translate, Toast) {
     ...
     */
    this.success = function (translationId, translationParams) {
     ...
     */
    this.info = function (translationId, translationParams) {
     ...
     * @param  {string|object} translationIdOrHttpError         - Translation ID or HTTP error object
     * @param  {string|object} translationParamsOrTranslationId - (Optional) Translation params or Translation ID (if 1st param is the HTTP error object)
     * @return {function}                                       - The Toast instance
     *
     * @example
     ...
     */
    this.error = function (translationIdOrHttpError, translationParamsOrTranslationId) {
        ...
        } else if (angular.isObject(translationIdOrHttpError)) {
            return Toast.error([
